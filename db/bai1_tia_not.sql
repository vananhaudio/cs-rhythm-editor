...
BEGIN
  ...
  INSERT INTO flows (lesson_id, title, reward_xp, status, slides) VALUES (
    ...
    $json$[
      ...
      {"id":"s2","order":2,"logic":"NHAN","type":"text","title":"Nốt Mi trên khuông nhạc","content":"Mỗi nốt có một chỗ ngồi riêng trên khuông nhạc. <b>Nốt Mi</b> nằm ở dòng kẻ dưới cùng. Khi thấy nốt này, em chỉ cần nhớ tên nó là <b>Mi</b>."},
      {"id":"s3","order":3,"logic":"NHAN","type":"text","title":"Mi = dây 1 buông","content":"Nốt Mi chính là <b>dây 1 buông</b> — dây mỏng nhất của đàn. Buông nghĩa là tay trái không bấm phím nào, tay phải gảy đúng dây đó."},
      {"id":"s4","order":4,"logic":"LAM","type":"note_practice","title":"Đánh theo: nốt Mi","interactive":{"notes":[{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":0},{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":0},{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":0},{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":0}]}},
