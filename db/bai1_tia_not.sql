...
BEGIN
  ...
  INSERT INTO flows (lesson_id, title, reward_xp, status, slides) VALUES (
    ...
    $json$[
      {"id":"s1","order":1,"logic":"DAN","type":"callout","title":"Nốt Mi — dây 1 buông","interactive":{"variant":"teacher"},"content":"Hôm nay bạn làm quen nốt nhạc đầu tiên trên đàn guitar: <b>nốt Mi</b>. Cùng nhìn, chơi và luyện tập nhé!"},
      {"id":"s2","order":2,"logic":"NHAN","type":"note_show","title":"Nhìn trên khuông nhạc","interactive":{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":7,"showStaff":true,"showFretboard":false,"caption":"Đây là nốt <b>Mi</b>. Trên đàn guitar, Mi được viết ở <b>khe thứ 4</b> của khuông nhạc — khi thấy nốt ở đây, bạn nhớ tên nó là <b>Mi</b>."}},
