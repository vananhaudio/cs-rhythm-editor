...
BEGIN
  ...
  INSERT INTO flows (lesson_id, title, reward_xp, status, slides) VALUES (
    ...
    $json$[
      ...
      {"id":"s2","order":2,"logic":"NHAN","type":"note_show","title":"Nhìn trên khuông nhạc","interactive":{"label":"Mi","freq":329.63,"string":1,"fret":0,"staff":0,"showStaff":true,"showFretboard":false,"caption":"Đây là nốt <b>Mi</b>. Mỗi nốt có một chỗ ngồi riêng trên khuông nhạc — khi thấy nốt này, em nhớ tên nó là <b>Mi</b>."}},
