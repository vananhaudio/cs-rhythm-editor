...
INSERT INTO flows (id, lesson_id, title, status, reward_xp, slides)
VALUES ('a2200003-0000-4000-8000-000000000003', 'a2100003-0000-4000-8000-000000000003', 'Bài tập: Nghe & nhìn trường độ', 'published', 10, '[{"id":"d1","order":1,"logic":"DAN","type":"callout","title":"Trường độ — dài ngắn của nốt","interactive":{"variant":"tip"},"content":"Cùng một cao độ nhưng <b>hình nốt khác nhau</b> thì ngân <b>dài ngắn khác nhau</b>. Nghe mẫu để cảm nhận rõ."},{"id":"d2","order":2,"logic":"LAM","type":"note_practice","title":"Đen (1) → Trắng (2) → Tròn (4)","interactive":{"noFretboard":true,"showDur":true,"beatsPerBar":4,"hint":"Ô 1: bốn nốt đen (mỗi nốt 1 phách). Ô 2: hai nốt trắng (2 phách). Ô 3: một nốt tròn (ngân trọn 4 phách).","notes":[{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":1},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":1},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":1},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":1},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":2},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":2},{"label":"La","freq":220,"string":3,"fret":2,"staff":3,"dur":4}]}},{"id":"d3","order":3,"logic":"NGAM","type":"checklist","title":"Tự kiểm tra","interactive":{"items":["Mình nghe rõ nốt tròn ngân dài gấp 4 lần nốt đen","Mình nhận ra đầu nốt rỗng = trắng/tròn, đầu đặc = đen"]}}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, status = EXCLUDED.status, reward_xp = EXCLUDED.reward_xp, slides = EXCLUDED.slides;
...
INSERT INTO flows (id, lesson_id, title, status, reward_xp, slides)
VALUES ('a2200005-0000-4000-8000-000000000005', 'a2100005-0000-4000-8000-000000000005', 'Bài tập: Đọc một câu nhạc', 'published', 12, '[{"id":"r1","order":1,"logic":"DAN","type":"callout","title":"Đọc trọn một câu nhạc","interactive":{"variant":"tip"},"content":"Ghép mọi thứ đã học: <b>tên nốt + trường độ + ô nhịp</b>. Nghe mẫu một lượt cho quen, rồi Tự đàn theo nhịp."},{"id":"r2","order":2,"logic":"LAM","type":"note_practice","title":"Câu nhạc ngắn — nhịp 4/4","interactive":{"noFretboard":true,"showDur":true,"beatsPerBar":4,"hint":"Đọc lần lượt: tên nốt kèm trường độ. Câu kết bằng nốt trắng (Đô, ngân 2 phách).","notes":[{"label":"Đô","freq":130.81,"string":5,"fret":3,"staff":-2,"dur":1},{"label":"Rê","freq":146.83,"string":4,"fret":0,"staff":-1,"dur":1},{"label":"Mi","freq":164.81,"string":4,"fret":2,"staff":0,"dur":1},{"label":"Fa","freq":174.61,"string":4,"fret":3,"staff":1,"dur":1},{"label":"Mi","freq":164.81,"string":4,"fret":2,"staff":0,"dur":1},{"label":"Rê","freq":146.83,"string":4,"fret":0,"staff":-1,"dur":1},{"label":"Đô","freq":130.81,"string":5,"fret":3,"staff":-2,"dur":2}]}},{"id":"r3","order":3,"logic":"NGAM","type":"checklist","title":"Tự kiểm tra","interactive":{"items":["Mình đọc trôi cả câu, không dừng giữa chừng","Mình giữ phách đều từ đầu đến cuối"]}}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, status = EXCLUDED.status, reward_xp = EXCLUDED.reward_xp, slides = EXCLUDED.slides;
