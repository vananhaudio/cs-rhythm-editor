      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 'calc(90px + env(safe-area-inset-bottom))' }}>
        ...
        {tab === 'home' && (() => {
          ...
          <div style={{ paddingBottom: 8 }}>
            ...
            {/* BẢN TIN HÔM NAY — server-driven feed (src/HomeFeed.tsx, bảng home_feed_items) */}
            <HomeFeedSection
              palette={{ surface: L.surface, surface2: L.surface2, t1: L.t1, t2: L.t2, t3: L.t3, p1: L.p1, shadow: L.shadow }}
              onOpenNative={(route, title) => openTool(route, title)}
            />
