...
const TOPIC_LABELS: Record<string, string> = {
  'ban-be': 'Bạn bè', 'band': 'Band',
  'bat-dau-hoc-guitar': 'Bắt đầu học Guitar', 'bieu-dien': 'Biểu diễn',
  'dai-hoi-guitar': 'Đại hội Guitar', 'dong-luc': 'Động lực',
  'gia-dinh': 'Gia đình', 'nguoi-thay': 'Người thầy',
}
