...
.sc-loading { text-align: center; padding: 60px; color: #8A8499; }
.sc-header { display: flex; align-items: center; gap: 16px; margin-bottom: 24px; flex-wrap: wrap; }
.sc-back { background: none; border: none; color: #4338CA; font-size: 14px; font-weight: 500; cursor: pointer; padding: 0; }
.sc-back:hover { text-decoration: underline; }
.sc-title { font-size: 22px; font-weight: 700; color: #211C32; margin: 0; flex: 1; }
.sc-add-btn { padding: 8px 16px; background: #4338CA; color: #fff; border: none; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; font-family: inherit; }
.sc-add-btn:hover { background: #352BA3; }

.sc-list { display: flex; flex-direction: column; gap: 8px; }
.sc-empty { text-align: center; padding: 40px; color: #8A8499; font-size: 14px; }
.sc-row { display: flex; align-items: center; justify-content: space-between; padding: 14px 16px; background: #fff; border: 1px solid #E4DED4; border-radius: 10px; gap: 12px; }
.sc-row:hover { border-color: #C4BED4; }
.sc-inactive { opacity: 0.6; }
.sc-row-info { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; min-width: 0; }
.sc-row-name { font-weight: 600; color: #211C32; font-size: 15px; }
.sc-row-slug { font-size: 13px; color: #8A8499; font-family: monospace; }
.sc-row-order { font-size: 12px; color: #C4BED4; }
...
.sc-edit-btn { padding: 6px 12px; background: none; border: 1px solid #D3CEE8; border-radius: 6px; color: #4338CA; font-size: 12px; cursor: pointer; font-family: inherit; }
.sc-edit-btn:hover { background: #EEEBFB; }
...
.sc-form h3 { margin: 0 0 20px; font-size: 18px; font-weight: 700; color: #211C32; }
.sc-form label { display: block; margin-bottom: 14px; font-size: 13px; font-weight: 600; color: #5A5470; }
.sc-form input[type="text"],
.sc-form input[type="number"] { width: 100%; padding: 10px 12px; border: 1px solid #E4DED4; border-radius: 8px; font-size: 14px; margin-top: 4px; box-sizing: border-box; font-family: inherit; }
.sc-form input:focus { outline: none; border-color: #4338CA; }
...
.sc-cancel-btn { padding: 8px 16px; background: none; border: 1px solid #E4DED4; border-radius: 8px; font-size: 13px; cursor: pointer; font-family: inherit; color: #5A5470; }
.sc-save-btn { padding: 8px 16px; background: #4338CA; color: #fff; border: none; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; font-family: inherit; }
.sc-save-btn:hover { background: #352BA3; }
