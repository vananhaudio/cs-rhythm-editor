...
const SAMPLE_FLOW_HOPAM = {
  ...
  slides: [
    ...
    { id: 'h4', order: 4, logic: 'NHAN', type: 'guitar_chord', title: 'Hợp âm trên guitar',
      interactive: { name: 'Em', caption: 'Trên guitar, tay trái bấm cần đàn, tay phải gảy nhiều dây → nhiều nốt vang cùng lúc = một hợp âm. Đây là thế bấm <b>Em</b>. Bấm <b>Nghe</b> rồi gảy thử trên đàn của em.' } },
