...
// Diễm Xưa — BẢN CÓ BASS (Buổi 02): cùng giai điệu/hợp âm như trên, script tự chèn
// nốt gốc trên dây trầm tại mỗi lần đổi hợp âm (--bass). Tất cả đều là dây buông:
// E (dây 6) · A (dây 5) · D (dây 4) — ngón cái p chơi cùng lúc với nốt giai điệu.
export const WORK_DIEM_XUA_BASS = `\\ts 4 4
\\lyrics "Mưa vẫn mưa bay trên tầng tháp cổ Dài tay em mấy thuở mắt xanh xao Nghe lá thu mưa reo mòn gót nhỏ Đường dài hun hút cho mắt thêm sâu Chợt hồn xanh buốt cho mình xót xa Chiều nay còn mưa sao em không lại Nhớ mãi trong cơn đau vùi làm sao có nhau hằn lên nỗi đau Bước chân em xin về mau Mưa vẫn hay mưa cho đời biển động Làm sao em biết bia đã không đau Xin hãy cho mưa qua miền đất rộng Để người phiêu lãng quên mình lãng du Ngày sau sỏi đã cũng cần có nhau"
.
\\ro r.8 0.1.8 1.1.8 0.1.8 0.1.8 1.2.8 2.3.8 1.2.8 |
(0.5{rf 1} 2.4{ch "Am"}).1 |
r.8 2.3.8 1.2.8 0.1.8 (0.5{rf 1} 3.1{ch "A7"}).8 3.1.8 5.1.8 0.1.8 |
(0.4{rf 1} 3.2{ch "Dm"}).1 |
r.8 0.1.8 1.1.8 0.1.8 0.1.8 1.2.8 (0.5{rf 1} 2.3{ch "Am"}).8 1.2.8 |
(0.6{rf 1} 2.4{ch "E"}).1 |
r.8 2.4.8 1.3.8 0.2.8 3.2.8 3.2.8 0.1.8 3.2.8 |
\\rc 2 (0.5{rf 1} 1.2{ch "Am"}).1 |
r.8 (0.6{rf 1} 2.4{ch "E"}).8 1.3.8 0.2.8 3.2.8 0.2.8 1.3.8 0.2.8 |
(0.5{rf 1} 2.3{ch "Am"}).1 |
r.4 0.1.8{tu 3} 1.1.8{tu 3} 0.1.8{tu 3} (0.5{rf 1} 5.1{ch "A7"}).8 5.1.8 5.1.8 5.1.8 |
(0.4{rf 1} 6.2{ch "Dm"}).4{d} 5.1.8 5.1.8 5.1.8 5.1.8 5.1.8 |
(0.5{rf 1} 0.1{ch "Am"}).4 2.3.8{tu 3} 1.2.8{tu 3} 0.1.8{tu 3} (0.4{rf 1} 3.2{ch "Dm"}).4 3.2.8{tu 3} 1.1.8{tu 3} 5.1.8{tu 3} |
(0.6{rf 1} 4.1{ch "E"}).4{d} 0.1.8 3.2.8 1.2.8 0.2.8 2.3.8 |
(0.6{rf 1} 0.2{ch "E"}).1 |
r.8 0.1.8 1.1.8 0.1.8 0.1.8 1.2.8 2.3.8 1.2.8 |
(0.5{rf 1} 2.4{ch "Am"}).1 |
r.8 2.3.8 1.2.8 0.1.8 (0.5{rf 1} 3.1{ch "A7"}).8 3.1.8 5.1.8 0.1.8 |
(0.4{rf 1} 3.2{ch "Dm"}).1 |
r.8 0.1.8 1.1.8 0.1.8 0.1.8 (0.5{rf 1} 1.2{ch "Am"}).8 2.3.8 1.2.8 |
(0.6{rf 1} 2.4{ch "E"}).1 |
r.8 2.4.8 1.3.8 0.2.8 3.2.8 0.2.8 1.3.8 0.2.8 |
(0.5{rf 1} 2.3{ch "Am"}).1 |
r.8 2.4.8 1.3.8 0.2.8 3.2.8 (0.6{rf 1} 0.2{ch "E"}).8 1.3.8 0.2.8 |
(0.5{rf 1} 2.3{ch "Am"}).1`
